...
/************************************
Changed from OMOP V5.2
distkey and sortkey were not found in this table.
changed them to a field that is a part of this table.
*************************************/
...
distkey(visit_occurrence_id)
sortkey(visit_occurrence_id);
...
/************************
offset is a reserved word in Redshift.
changed the field name to 'offset_value' to meet this requirement.
*************************/
